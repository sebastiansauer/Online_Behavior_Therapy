...
points(nr_predictors, LM_regsubsets_summary$adjr2[nr_predictors], col = "red", cex = 2, pch = 20)
```
...
points(nr_predictors, LM_regsubsets_summary$bic[nr_predictors], col = "red", cex = 2, pch = 20)
```
...
points(nr_predictors, LM_regsubsets_summary$cp[nr_predictors], col = "red", cex = 2, pch = 20)
```
