...
So out of all predictors, it appears that only 4 are statistically significant. That is, the two outcome groups differ statistically significantly on these values:
